...
public class Track {
	...
	public static class TrackUtils {
        ...
        public static Track mergeSequenceToTrack( final Sequencer sequencer,  final Map<Track, Set<Integer>> recordEnable) throws InvalidMidiDataException {
		 ...
		 */
		public static void sortEvents( final Track track) {
	 ...
	 */
	public boolean add( final MidiEvent event) {
		synchronized (events) {
