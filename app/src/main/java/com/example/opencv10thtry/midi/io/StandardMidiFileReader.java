package com.example.opencv10thtry.midi.io;
...
import com.example.opencv10thtry.midi.spi.MidiFileReader;
...
public class StandardMidiFileReader extends MidiFileReader {
	...
	private static class MidiDataInputStream extends DataInputStream {
         ...
         */
		public MidiDataInputStream( final InputStream inputStream) {
			super(inputStream);
		}
	...
	private static ShortMessage processSystemMessage(final int data1, final Integer data2,  final DataInput midiDataInputStream) throws InvalidMidiDataException, IOException {
    ...
    private static ShortMessage processRunningMessage(final int status, final int data1,  final DataInput midiDataInputStream) throws InvalidMidiDataException, IOException {
		final ShortMessage shortMessage;
    ...
    private static ByteArrayInputStream convertToByteArrayInputStream( final InputStream inputStream) throws IOException {
