...
import com.example.opencv10thtry.midi.spi.MidiFileWriter;
...
public class StandardMidiFileWriter extends MidiFileWriter {
    ...
    private static class MidiDataOutputStream extends DataOutputStream {
         ...
         */
		public MidiDataOutputStream( final OutputStream outputStream) {
			super(outputStream);
		}
	...
	@Override
	public int write( final Sequence sequence, final int fileType,  final File file) throws IOException {
	...
	@Override
	public int write( final Sequence sequence, final int fileType,  final OutputStream outputStream) throws IOException {
	 ...
	 * @throws IOException
	 */
	private static int writeTrack( final Track track,  final MidiDataOutputStream midiDataOutputStream) throws IOException {
