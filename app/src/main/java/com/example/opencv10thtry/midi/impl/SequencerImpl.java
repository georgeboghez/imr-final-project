package com.example.opencv10thtry.midi.impl;
...
import com.example.opencv10thtry.midi.ControllerEventListener;
import com.example.opencv10thtry.midi.InvalidMidiDataException;
import com.example.opencv10thtry.midi.MetaEventListener;
import com.example.opencv10thtry.midi.MetaMessage;
import com.example.opencv10thtry.midi.MidiEvent;
import com.example.opencv10thtry.midi.MidiMessage;
import com.example.opencv10thtry.midi.MidiSystem.MidiSystemUtils;
import com.example.opencv10thtry.midi.MidiUnavailableException;
import com.example.opencv10thtry.midi.Receiver;
import com.example.opencv10thtry.midi.Sequence;
import com.example.opencv10thtry.midi.Sequencer;
import com.example.opencv10thtry.midi.ShortMessage;
import com.example.opencv10thtry.midi.SysexMessage;
import com.example.opencv10thtry.midi.Track;
import com.example.opencv10thtry.midi.Track.TrackUtils;
import com.example.opencv10thtry.midi.Transmitter;
...
public class SequencerImpl implements Sequencer {
    ...
    private class SequencerThread extends Thread {
         ...
         */
        private void fireEventListeners( final MidiMessage message) {
         ...
         */
        private boolean processTempoChange( final MetaMessage metaMessage) {
         ...
         */
        private boolean isRecordable(final Collection<Integer> recordEnableChannels,  final MidiEvent midiEvent) {
    ...
    @Override
    public int[] addControllerEventListener( final ControllerEventListener listener,  final int[] controllers) {
        synchronized (controllerEventListenerMap) {
    ...
    @Override
    public int[] removeControllerEventListener( final ControllerEventListener listener,  final int[] controllers) {
        synchronized (controllerEventListenerMap) {
    ...
    @Override
    public void setMasterSyncMode( final SyncMode sync) {
    ...
    @Override
    public void setSequence( final InputStream stream) throws IOException, InvalidMidiDataException {
    ...
    @Override
    public void setSlaveSyncMode( final SyncMode sync) {
