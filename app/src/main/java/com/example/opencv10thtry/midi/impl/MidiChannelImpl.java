...
import com.example.opencv10thtry.midi.MidiChannel;
import com.example.opencv10thtry.midi.Receiver;
import com.example.opencv10thtry.midi.ShortMessage;
import com.example.opencv10thtry.midi.VoiceStatus;
...
public final class MidiChannelImpl implements MidiChannel {
     ...
     */
    public MidiChannelImpl(final int channel,  final Receiver receiver,  final VoiceStatus voiceStatus) {
