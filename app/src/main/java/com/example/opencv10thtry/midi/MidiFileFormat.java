...
public class MidiFileFormat {
     ...
     */
	public MidiFileFormat(final int type, final float divisionType, final int resolution, final int bytes, final long microseconds,  final Map<String, Object> properties) {
